...
if(uppdatera_data == TRUE){
  ...
  output_mapp_figur = here::here("figurer","/")
  
  cat("Hämtning av data påbörjad\n")
  start_time <- Sys.time()
  
  # Antal företag uppdelat på omsättning (från SCB:s företagsdatabas)
  source(here::here("skript","diag_foretag_oms_anst_fdb.R"), encoding="UTF-8")
  gg_fdb_oms_anst <- diag_fdb_omsattning_mm(skriv_diagramfil = spara_figurer,
  ...
  gg_forv_90 <- rdverktyg::funktion_upprepa_forsok_om_fel(function() {
    diagram_forvarvsarbetande_90(output_mapp_figur = output_mapp_figur,
                                 ...
                                 returnera_data = TRUE,
                                 vald_farg = rddiagram::diagramfarger("rus_sex"))
  ...
  source(here::here("skript","diag_aktiva_foretag_mm_tva.R"), encoding="UTF-8")
  gg_aktiva_foretag <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_aktiva_foretag_bransch_lan(cont_klartext = "Antal aktiva företag",
  ...
  gg_nyetablerade_foretag <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_aktiva_foretag_bransch_lan(cont_klartext = "Antal nyetablerade företag",
                                                                                                    skriv_diagramfil = spara_figurer,
  ...
  gg_nedlagda_foretag <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_aktiva_foretag_bransch_lan(cont_klartext = "Antal nedlagda företag",
                                                                                                         skriv_diagramfil = spara_figurer,
                                                                                                         diagram_capt = "Källa: Tillväxtanalys. Bearbetning: Samhällsanalys, Region Dalarna.",
                                                                                                         output_mapp = output_mapp_figur,
                                                                                                         returnera_data_rmarkdown = TRUE)
  ...
  source(here::here("skript","diag_aktiva_foretag_mm_storleksklass_tva.R"), encoding="UTF-8")
  gg_aktiva_foretag_storleksklass <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_aktiva_foretag_storleksklass_lan(cont_klartext = "Antal aktiva företag",
                                                                                                   skriv_diagramfil = spara_figurer,
                                                                                                   output_mapp = output_mapp_figur,
                                                                                                   diag_facet = FALSE,
  ...
  # Förädlingsvärde
  source(here::here("skript","diag_fek_bransch_fran_2022_korrekt.R"), encoding="UTF-8")
  gg_foradlingsvarde_bransch <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_fek_bransch_lan_scb(skriv_diagramfil = spara_figurer,
                                                                                                     output_mapp = output_mapp_figur,
                                                                                                     returnera_data_rmarkdown = TRUE)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  # Nettoomsättning
  source(here::here("skript","diag_fek_bransch_fran_2022_korrekt.R"), encoding="UTF-8")
  gg_nettoomsattning_bransch <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_fek_bransch_lan_scb(cont_klartext = "Nettoomsättning exkl. merchantingkostnader, mnkr",
                                                                                                     skriv_diagramfil = spara_figurer,
                                                                                                     output_mapp = output_mapp_figur,
                                                                                                     returnera_data_rmarkdown = TRUE)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  source(here::here("skript","diag_fek_bransch_fran_2022_korrekt.R"), encoding="UTF-8")
  gg_antal_anstallda_bransch <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_fek_bransch_lan_scb(cont_klartext = "Antal anställda",
                                                                                                     skriv_diagramfil = spara_figurer,
                                                                                                     output_mapp = output_mapp_figur,
                                                                                                     returnera_data_rmarkdown = TRUE)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  gg_brp_per_sysselsatt <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diagram_brp_sysselsatt(region_vekt = "20",
                                                                                              output_mapp = output_mapp_figur,
                                                                                              returnera_data = TRUE,
  ...
  gg_brp_invanare <- rdverktyg::funktion_upprepa_forsok_om_fel( function() { diag_brp_per_inv_scb(region_vekt = "20",
                                                                                       output_mapp = output_mapp_figur,
                                                                                       returnera_data_rmarkdown  = TRUE,
                                                                                       skriv_diagramfil = spara_figurer)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  source(here::here("skript","diag_utlanskt_agande_anstallda_arbetsstallen.R"), encoding="UTF-8")
  gg_utlandskt_agande_anstallda <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_utlandskt_agande_bransch_land(cont_klartext = "Antal anställda",
                                                                                                                  skriv_diagramfil = spara_figurer,
                                                                                                                  output_mapp = output_mapp_figur,
                                                                                                                  returnera_data_rmarkdown = TRUE)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  source(here::here("skript","diag_utlanskt_agande_anstallda_arbetsstallen.R"), encoding="UTF-8")
  gg_utlandskt_agande_arbetsstallen <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_utlandskt_agande_bransch_land(cont_klartext = "Antal arbetsställen",
                                                                                                                      skriv_diagramfil = spara_figurer,
                                                                                                                      output_mapp = output_mapp_figur,
                                                                                                                      returnera_data_rmarkdown = TRUE)
  }, hoppa_over = hoppa_over_felhantering)
  ...
  save.image(file = glue::glue("{mapp_environment_fil}{repo_namn}.RData"))
  ...
  load(glue::glue("{mapp_environment_fil}{repo_namn}.RData"))
}

# Går inte att ladda in från global environment, så skapas alltid här i slutet
# Största arbetsgivare - 1 diagram
source(here::here("skript","storsta_arbetsgivare_tabell_ny.R"), encoding="UTF-8")
gg_storsta_arbetsgivare <- rdverktyg::funktion_upprepa_forsok_om_fel( function() {diag_storsta_arbetsgivare(returnera_data = TRUE)
}, hoppa_over = hoppa_over_felhantering)
